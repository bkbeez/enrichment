...
<body data-theme-color="color-purple">
				...
				<div class="container">
					<div class="header-content">
						<div class="left-content">
							...
							<h5 class="title mb-0 text-nowrap">บริการวิชาการ</h5>
						</div>
						<div class="mid-content"></div>
						<div class="right-content">
							<button type="button" class="btn btn p-0 position-relative mx-2">
								<i class="bi bi-cart fa-2x text-dark"></i>
								<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill" style="background-color: red; border: 2px solid white;">1</span>
							</button>
							<button type="button" class="btn btn p-0 position-relative mx-2">
								<i class="bi bi-chat-dots fa-2x text-dark"></i>
								<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill" style="background-color: red; border: 2px solid white;">1</span>
							</button>
						</div>
					</div>
				...
				<div class="container p-b30">
					...
					<div class="dashboard-area">
						...
						<div class="title-bar mt-0">
							...
							<a class="btn-link" href="product-categorie.html">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="row g-3 mb-3">
							<div class="col-6">
								<div class="card-item style-1">
									...
									<div class="dz-content">
										<h6 class="title mb-3"><a href="product.html">Fresh Grapes</a></h6>
										<div class="dz-meta">
											<ul>
							...
							<div class="col-6">
								<div class="card-item style-1">
									...
									<div class="dz-content">
										<h6 class="title mb-3"><a href="product.html">Gurame Fish</a></h6>
										<div class="dz-meta">
											<ul>
												<li class="price text-accent">$ 10.9</li>
												<li class="review">
							...
							<div class="col-6">
								<div class="card-item style-1">
									...
									<div class="dz-content">
										<h6 class="title mb-3"><a href="product.html">Tomatoes</a></h6>
										<div class="dz-meta">
											<ul>
												<li class="price text-accent">$ 10.9</li>
												<li class="review">
							...
							<div class="col-6">
								<div class="card-item style-1">
									...
									<div class="dz-content">
										<h6 class="title mb-3"><a href="product.html">Chicken Village</a></h6>
										<div class="dz-meta">
											<ul>
												<li class="price text-accent">$ 10.9</li>
												<li class="review">
							...
							<div class="col-6">
								<div class="card-item style-1">
									...
									<div class="dz-content">
										<h6 class="title mb-3"><a href="product.html">Fresh Milk</a></h6>
										<div class="dz-meta">
											<ul>
												<li class="price text-accent">$ 10.9</li>
												<li class="review">
							...
							<div class="col-6">
								<div class="card-item style-1">
									...
									<div class="dz-content">
										<h6 class="title mb-3"><a href="product.html">Fresh Avocados</a></h6>
										<div class="dz-meta">
											<ul>
												<li class="price text-accent">$ 10.9</li>
												<li class="review">
					...
					<div class="row g-3">
						<div class="col-6">
							<div class="package-box box-1">
								...
								<h6 class="title-head">W3 Vendor</h6>
								<p class="sub-title">Continue With Vendor</p>
								<a href="vendors/onboarding.html" class="btn package-btn">Click Now
						...
						<div class="col-6">
							<div class="package-box box-2">
								...
								<h6 class="title-head">W3 Driver</h6>
								<p class="sub-title">Continue With Driver</p>
								<a href="driver/onboarding.html" class="btn package-btn">Click Now
									<i class="fa-solid fa-arrow-right ms-2"></i>
								</a>
							</div>
						</div>
